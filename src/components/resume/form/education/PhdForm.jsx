...
import { asyncAddPhd } from "../../../../store/actions/studentActions";
...
const PhdForm = () => {
  ...
  const phdSubmitHandler = (e) => {
    ...
    dispatch(asyncAddPhd(phdDetails));
        ...
        >
          ...
          <div className="w-full">
            ...
            <input
              ...
              type="text"
              id="stream"
              placeholder="e.g. Commerce & Bussiness Studies"
              className="w-full px-4 py-2  mt-1 outline-1 outline-sky-200 border rounded"
            />
          </div>
